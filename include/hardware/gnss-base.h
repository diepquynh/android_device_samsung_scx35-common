...
enum {
	GPS_DELETE_EPHEMERIS = 1, // 0x00000001
	GPS_DELETE_ALMANAC = 2, // 0x00000002
    GPS_DELETE_POSITION = 4, // 0x00000004
    GPS_DELETE_TIME = 8, // 0x00000008
    GPS_DELETE_IONO = 16, // 0x00000010
    GPS_DELETE_UTC = 32, // 0x00000020
    GPS_DELETE_HEALTH = 64, // 0x00000040
    GPS_DELETE_SVDIR = 128, // 0x00000080
    GPS_DELETE_SVSTEER = 256, // 0x00000100
    GPS_DELETE_SADATA = 512, // 0x00000200
    GPS_DELETE_RTI = 1024, // 0x00000400
    GPS_DELETE_CELLDB_INFO = 2048, // 0x00000800
	GPS_DELETE_ALMANAC_CORR = 4096, // 0x00001000
	GPS_DELETE_FREQ_BIAS_EST = 8192, // 0x00002000
	GLO_DELETE_EPHEMERIS = 16384, // 0x00004000
	GLO_DELETE_ALMANAC = 32768, // 0x00008000
	GLO_DELETE_SVDIR = 65536, // 0x00010000
	GLO_DELETE_SVSTEER = 131072, // 0x00020000
	GLO_DELETE_ALMANAC_CORR = 262144, // 0x00040000
	GPS_DELETE_TIME_GPS = 524288, // 0x00080000
	GLO_DELETE_TIME = 1048576, // 0x00100000
	BDS_DELETE_SVDIR = 2097152, // 0x00200000
	BDS_DELETE_SVSTEER = 4194304, // 0x00400000
	BDS_DELETE_TIME = 8388608, // 0x00800000
	BDS_DELETE_ALMANAC_CORR = 16777216, // 0x01000000
	BDS_DELETE_EPHEMERIS = 33554432, // 0x02000000
	BDS_DELETE_ALMANAC = 67108864, // 0x04000000

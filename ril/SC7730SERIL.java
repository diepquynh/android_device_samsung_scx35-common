...
public class SC7730SERIL extends RIL implements CommandsInterface {
    ...
    public SC7730SERIL(Context context, int networkMode, int cdmaSubscription, Integer instanceId) {
